...
**Reproduce.** Clone github.com/ubeast/logjam, backfill the database to 2023, then `uv run python scripts/reports/horn_of_africa_2026.py`. Full method in `docs/METHODOLOGY.md`.
